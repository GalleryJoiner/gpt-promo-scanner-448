...
```bash
git clone https://github.com/GalleryJoiner/gpt-promo-scanner-448.git
cd gpt-promo-scanner-448
python setup.py
```
...
```bash
git clone https://github.com/GalleryJoiner/gpt-promo-scanner-448
...
<!-- Last updated: 2026-06-06 16:20:52 -->
